...
export default function App() {
  ...
  if (loading) {
    ...
    const appContent = (
    <div className={`bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 transition-colors flex flex-col justify-between font-sans selection:bg-emerald-650 selection:text-white pb-0 overflow-x-hidden w-full`}>
